...
// Přidání svatebního dne do kalendáře (iPhone, Android i počítač).
function addToCalendar() {
    const ics = [
        "BEGIN:VCALENDAR",
        "VERSION:2.0",
        "PRODID:-//Stepanka a Tomas//Svatba//CS",
        "CALSCALE:GREGORIAN",
        "BEGIN:VEVENT",
        "UID:stepanka-tomas-svatba-2027@example.com",
        "DTSTAMP:20260830T160000Z",
        "DTSTART;TZID=Europe/Prague:20270508T110000",
        "DTEND;TZID=Europe/Prague:20270508T235900",
        "SUMMARY:Svatební den – Štěpánka & Tomáš",
        "LOCATION:MLÝN 1774\, Dzbel 43",
        "DESCRIPTION:Svatební den Štěpánky a Tomáše. Obřad začíná v 11:00.",
        "END:VEVENT",
        "END:VCALENDAR"
    ].join("\r\n");
    ...
    link.href = url;
    link.download = "svatba-stepanka-tomas-8-5-2027.ics";
